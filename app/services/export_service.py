...
class ExportService:
    def export_csv(self, task: dict) -> dict:
        ...
        headers = [
            'webmaster_id', 'ad_type_id', 'ad_type_name', 'country_id', 'country_name',
            'advertiser_id', 'site_id', 'site_name', 'site_real_domain_id', 'site_real_domain',
            'impression', 'clicks', 'ctr', 'cpm_wm', 'cpm_n', 'webmaster_profit', 'network_profit',
            'source', 'checked_at'
        ]
